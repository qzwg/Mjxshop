...
<body>
 <div class="margin clearfix">
   <div class="border clearfix">
       <span class="l_f">
			 <a href="{{URL('privilege/create')}}" id="Competence_add" class="btn btn-warning" title="添加角色"><i class="fa fa-plus"></i> 添加角色</a>
        <a href="{{URL('privilege/show')}}" id="Competence_add" class="btn btn-warning" title="添加权限"><i class="fa fa-plus"></i>添加权限</a>
			...
			<tr>
             ...
             <tbody>
			  ...
			  <tr>
				...
				<td>{{$v->control}}</td>
				<td>{{$v->num}}</td>
				<td class="hidden-480">@if(!$v->admin == '') {{$v->admin}} @else 空 @endif</td>
				<td>{{$v->explain}}</td>
				<td>
