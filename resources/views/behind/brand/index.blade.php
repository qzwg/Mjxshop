  ...
  <div id="brand_style">
    <div class="search_style">
     ...
     <div class="border clearfix">
       <span class="l_f">
        <a href="{{URL('brand/create')}}"  title="添加品牌" class="btn btn-warning Order_form"><i class="icon-plus"></i>添加品牌</a>
    ...
    @foreach($brandMes as $k=>$v)
		<tr>
          ...
          <td><a href="javascript:ovid()" name="Brand_detailed.html" style="cursor:pointer" class="text-primary brond_name" onclick="generateOrders('561');" title="{{$v->name}}">{{$v->name}}</a></td>
          <td>{{$v->district}}</td>
          ...
          <a title="编辑" onclick="member_edit('编辑','{{url('brand/'.$v->id.'/edit')}}','4','','510')" href="javascript:;"  class="btn btn-xs btn-info" ><i class="icon-edit bigger-120"></i></a> 
