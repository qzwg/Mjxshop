...
<div class="login-container">
   ...
   <li class="frame_style form_error"><label class="Codes_icon"></label><input name="code" type="text"   id="Codes_text"/><i>验证码</i><div class="Codes_region"></div></li>
...
$('#login_btn').on('click', function(){
  ...
  $(document).ready(function(){
	...
	//   $ip = returnCitySN["cip"];
	//   alert($ip);
	  $("#ip").val(returnCitySN["cip"]+'-'+returnCitySN["cname"]);
