...
<div class="clearfix" id="add_picture">
   ...
   <div class="type_title">添加商品</div>
    <form action="{{URL('shop_add')}}" method="post" enctype="multipart/form-data" class="form form-horizontal" id="form-article-add">
    @csrf
        <div class="clearfix cl">
            <label class="form-label col-2"><span class="c-red">*</span>选择品牌：</label>
            <select name="cat00_id" id="">
        ...
        <!-- 选择属性名 -->
        <div class="clearfix cl" id="show_attr">
            <label class="form-label col-2"><span class="c-red">*</span>选择规格：</label>
            
		</div>

		<div class="clearfix cl">
         <label class="form-label col-2"><span class="c-red">*</span>图片封面：</label>
		 <div class="formControls col-10"><input type='file' class="preview" name='logo'></div>
        </div>
		<div class=" clearfix cl">
         <label class="form-label col-2">简略标题：</label>
	     <div class="formControls col-10"><input type="text" class="input-text" value="" placeholder="" id="" name="title"></div>
		</div>
		<div class=" clearfix cl">
            ...
            <div class="Add_p_s">
			 ...
			 <div class="formControls col-2"><input type="text" class="input-text" value="" placeholder="" id="" name="stock" >件</div>
			</div>
             <!-- <div class="Add_p_s">
            ...
            <div class="Add_p_s">
			 ...
			 <div class="formControls col-2"><input type="text" class="input-text" value="" placeholder="" id="" name="show_price" >元</div>
			</div>
            <div class="Add_p_s">
             <label class="form-label col-2">市场价格：</label>	
			 <div class="formControls col-2"><input type="text" class="input-text" value="" placeholder="" id="" name="bazzar_price" >元</div>
            </div>	
		</div>
<!--         
        ...
        <div id="attr-container">
                ...
                <div class="formControls col-2"><input type="text" class="input-text" placeholder="" id="" name="shop_value[]" ></div>
                </div>
                <div>
        ...
        <div id="image-container"  >
                <div class="Add_p_s" style="display:inline-block">
                    ...
                    <div class="formControls col-2"><input class="preview" type='file' name='image[]'></div>
                    <input  onclick="del_attr(this)" type="button" value="删除">
                </div>     
        </div>
        <br><hr>
...
<script>
     var attrStr = `<div><br><hr><div class="Add_p_s">
                ...
                <div class="Add_p_s">
                <label class="form-label col-2">属性值：</label>	
                <div class="formControls col-2"><input type="text" class="input-text" value="" placeholder="" id="" name="shop_value[]" ></div>
                </div> 
                <input onclick="del_attr(this)" type="button" value="删除">
                </div>`;
...
// 三级联动
$("select[name=cat00_id]").change(function(){
    // 取出这个分类的id
    var id = $(this).val()
    // alert(id);
    // 如果不为空就执行AJAX
                ...
                for(var i=0;i<data.length;i++)
                {
                    $.ajax({
                        ...
                        success:function(attr)
                        {
                            ...
                            {
                                valStr += '<option value="'+attr[j].id+'">'+attr[j].name+'</option>';
                            }
                        }
                    })
                    // alert(valStr);
                    str += '<label>&nbsp;'+data[i].name+'：</label><input type="hidden" name="attr_id[]" value="'+data[i].id+'" ><select name="cat_id[]" >'+valStr+'</select>';
                    // str += '<option value="'+data[i].id+'">'+data[i].name+'</option>';
                    valStr = "";
                }
                // 把拼好的 option 放到第二个下拉框中
                $("#show_attr").append(str)
                // 触发第二个框的 change 事件
