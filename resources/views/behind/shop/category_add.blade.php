...
<div class="type_style">
 <div class="type_title">产品类型信息</div>
  ...
  @endif
  <form action="{{URL('category')}}" method="post" class="form form-horizontal" id="form-user-add">
  @csrf
    <div class="Operate_cont clearfix">
      ...
      <div class="formControls ">
        <input type="text" class="input-text" value="" placeholder="" id="user-name" name="product-category-id">
      </div>
    </div>
    <div class="Operate_cont clearfix">
    <label class="form-label">备注：</label>
    <div class="formControls">
    <textarea name="explain" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="textarealength(this,100)"></textarea>
