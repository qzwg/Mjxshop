			...
			<div class="yui3-g SortList ">
				<div class="yui3-u Left all-sort-list">
					<div class="all-sort-list2">
						...
						<div class="item bo">
							<h3><a href="{{URL('sort/'.$v['id'].'')}}">{{$v['category']}}</a></h3>
							<div class="item-list clearfix">
								<div class="subitem">
									@foreach($v['gettwo'] as $i)
									<dl class="fore1">
										<dt><a href="{{URL('sort/'.$i['id'].'')}}">{{$i['category']}}</a></dt>
										<dd>
											@foreach($i['getsan'] as $j)
											<em><a href="{{URL('sort/'.$j['id'].'')}}">{{$j['category']}}</a></em>
											@endforeach
										</dd>
									</dl>
									@endforeach
