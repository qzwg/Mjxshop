                ...
                <div class="yui3-u-5-6">
                    <div class="body userInfo">
                        ...
                        <div class="tab-content ">
							...
							<form id="form-msg" action="{{url('info/mes/edit')}}" method="GET" class="sui-form form-horizontal">
								@csrf
                                    <div class="control-group">
                                        <label for="inputName" class="control-label">昵称：</label>
                                        <div class="controls">
                                            <input type="text" id="inputName" name="email" value="{{$data->name}}" placeholder="昵称">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label for="inputGender" class="control-label">性别：</label>
                                        <div class="controls">
                                            <label data-toggle="radio" class="inline">
                                            <input type="radio" name="gender" <?php if($data->sex == '1') echo 'checked'?> value="1"><span>男</span>
                                        </label>
                                            <label data-toggle="radio" class="inline">
                                            <input type="radio" name="gender" <?php if($data->sex == '0') echo 'checked'?> value="0"><span>女</span>
                                        </label>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <select id="select_year2" rel="{{$birth[0]}}" name="years"></select>年
                                            <select id="select_month2" rel="{{$birth[1]}}" name="month"></select>月
                                            <select id="select_day2" rel="{{$birth[2]}}" name="day"></select>日
                                        </div>
                                    </div>
