        ...
        <div class="default-list">
            ...
            <div class="goods-list">
                <ul class="yui3-g" id="goods-list">
                    ...
                    <li class="yui3-u-1-4">
                        <div class="list-wrap">
                            <div class="p-img"><a href="{{URL('shop_mes/'.$v->id.'/edit')}}"><img src="/{{$v->cover}}" alt=''></a></div>
                            <div class="price"><strong><em>¥</em> <i>{{$v->show_price}}</i></strong></div>
                            <!-- <div class="attr">{{$v->description}}</div> -->
                            <div class="cu"><em><span>促</span>{{$v->title}}</em></div><br>
                            <div class="operate">
