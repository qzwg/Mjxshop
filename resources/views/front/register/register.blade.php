...
<body>
	<div class="register py-container ">
		...
		<div class="registerArea">
			...
			@endif
				<form class="sui-form form-horizontal" action="{{url('register')}}" method="POST">
				@csrf
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="password" name="pwd" placeholder="设置登录密码" class="input-xfat input-xlarge">
						</div>
					</div>
					<div class="control-group">
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" name="mobile_code" placeholder="短信验证码" class="input-xfat input-xlarge">  
							<button id="btn-send" type="button">获取短信验证码</button>
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="m1" type="checkbox" value="2" checdked=""><span>同意协议并注册《品优购用户协议》</span>
						</div>
					</div>
					<div class="control-group">
